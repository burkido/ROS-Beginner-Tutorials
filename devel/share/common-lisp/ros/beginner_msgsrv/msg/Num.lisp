...
(cl:in-package beginner_msgsrv-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_msgsrv-msg:<Num> is deprecated: use beginner_msgsrv-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_msgsrv-msg:num-val is deprecated.  Use beginner_msgsrv-msg:num instead.")
  (num m))
