...
// (in-package beginner_msgsrv.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'beginner_msgsrv/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'beginner_msgsrv/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'beginner_msgsrv/AddTwoInts'; }
};
